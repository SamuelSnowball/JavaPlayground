...
import com.example.demo.generatedclasses.tables.daos.AuthorDao;
...
public class AuthorRepository extends AuthorDao {
    ...
    public com.example.demo.generatedclasses.tables.pojos.Author insert(String firstName, String lastName){
        AuthorRecord author = create.newRecord(AUTHOR);
        author.setFirstName(firstName);
        author.setLastName(lastName);
        author.store();
        com.example.demo.generatedclasses.tables.pojos.Author result = author.into(com.example.demo.generatedclasses.tables.pojos.Author.class);
    ...
    public void selectIntoMultipleObjects(String firstName, String lastName){
        ...
        List<com.example.demo.generatedclasses.tables.pojos.Author> authors = record.into(AUTHOR).into(Author.class);
