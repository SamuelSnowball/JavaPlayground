...
public class MyController {
    ...
    // To test spring whitelabel error page
    @GetMapping("/securedWithoutParameter")
    public ResponseEntity getSecuredWithoutParameter(@RequestParam(name="requiredParameter", required = false) 
