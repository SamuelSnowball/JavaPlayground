 ...
 */
package com.example.database.generatedclasses.tables;


import com.example.database.generatedclasses.Indexes;
import com.example.database.generatedclasses.Keys;
import com.example.database.generatedclasses.Mydatabase;
import com.example.database.generatedclasses.tables.Author.AuthorPath;
...
public class Book extends TableImpl<BookRecord> {
    ...
    /**
     * The reference instance of <code>mydatabase.book</code>
     */
    ...
    /**
     * The column <code>mydatabase.book.id</code>.
     */
    ...
    /**
     * The column <code>mydatabase.book.author_id</code>.
     */
    ...
    /**
     * The column <code>mydatabase.book.title</code>.
     */
    ...
    /**
     * Create an aliased <code>mydatabase.book</code> table reference
     */
    ...
    /**
     * Create a <code>mydatabase.book</code> table reference
     */
    public Book() {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.BOOK_AUTHOR_ID);
    }
    ...
    /**
     * Get the implicit join path to the <code>mydatabase.author</code> table.
     */
